...
class SemanticKITTIInternal:
    ...
    def __init__(self,
        ...
        ROAD = 8.
        self.label_map = np.where(self.label_map == ROAD, 1., 0.)
        for k in self.reverse_label_name_mapping:
            if k == 'road':
                self.reverse_label_name_mapping[k] = 1.
            else:
                self.reverse_label_name_mapping[k] = 0.
        self.reverse_label_name_mapping['road'] = 1.
